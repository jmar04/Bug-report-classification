...
project = 'pytorch'  # Change this to your desired project
path = f'{project}.csv'
...
REPEAT = 30 #changed number of repeats to match LAB
...
for repeated_time in range(REPEAT):
    ...
    #altered slightly according to https://scikit-learn.org/stable/modules/generated/sklearn.metrics.roc_auc_score.html#sklearn.metrics.roc_auc_score
    auc_val = roc_auc_score(y_test, best_clf.predict_proba(X_test)[:, 1])
